...
public class HeadGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.head_game_layout);
        navigateGridView = (GridView)findViewById(R.id.navigateGridView);
        navigateGridView.setVisibility(View.VISIBLE);
        InitNavigateItemList();
        NavigateItmeAdapter navigateItmeAdapter = new NavigateItmeAdapter(HeadGameActivity.this,R.layout.navigate_grid_item,navigateItemList);
        navigateGridView.setAdapter(navigateItmeAdapter);

        //初始化HorizontalScrollView
        mNewGameRecScrollLayout = (LinearLayout)findViewById(R.id.newGameScroll);
        InitRecGameInfoList();
        ...
        for(final NavigateItemInfo navigateItemInfo : navigateItemList) {
            navigateItemInfo.setBtnClickAction(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    Toast.makeText(HeadGameActivity.this,"点击了"+navigateItemInfo.geteItemType().getDes()+"按钮",Toast.LENGTH_SHORT).show();
                }
            });
        }
